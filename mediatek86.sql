...
-- Déclencheurs `livre`
--
DROP TRIGGER IF EXISTS `tr_livre_insert`;
DELIMITER $$
...
--
-- Structure de la table `livresdvd`
--

DROP TABLE IF EXISTS `livresdvd`;
...
--
-- Déchargement des données de la table `livresdvd`
--
...
--
-- Déclencheurs `livresdvd`
--
DROP TRIGGER IF EXISTS `tr_livresdvd_insert`;
DELIMITER $$
...
-- Déclencheurs `revue`
--
DROP TRIGGER IF EXISTS `tr_revue_insert`;
DELIMITER $$
...
ALTER TABLE `commandedocument`
  ...
  ADD CONSTRAINT `commandedocument_ibfk_2` FOREIGN KEY (`idLivreDvd`) REFERENCES `livresdvd` (`id`);
...
--
ALTER TABLE `dvd`
  ADD CONSTRAINT `dvd_ibfk_1` FOREIGN KEY (`id`) REFERENCES `livresdvd` (`id`);
...
--
ALTER TABLE `livre`
  ADD CONSTRAINT `livre_ibfk_1` FOREIGN KEY (`id`) REFERENCES `livresdvd` (`id`);

--
-- Contraintes pour la table `livresdvd`
--
ALTER TABLE `livresdvd`
  ADD CONSTRAINT `livresdvd_ibfk_1` FOREIGN KEY (`id`) REFERENCES `document` (`id`);
